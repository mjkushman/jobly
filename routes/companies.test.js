...
describe("POST /companies", function () {
  ...
  test("Unable to create a company if not an admin", async function () {
    const resp = await request(app)
      .post("/companies")
      .send({
        handle: "new1",
...
describe("GET /companies", function () {
  ...
  test("Filter to companies with minEmployees = 2 ", async () => {
  ...
  test("Filter to companies with maxEmployees = 1 ", async () => {
  ...
  test("Filter to companies with name like 'c2' ", async () => {
